...
Latest Build: [Version 2020.04.23.0001](https://github.com/MichalAFerber/ModMan/releases/download/2020.04.23.001/ModMan_v2020_04_23_0001.zip){: target="_blank" } | [GitHub](https://github.com/MichalAFerber/ModMan){: target="_blank" }

![ModManAbout.png](/assets/attachments/ModManAbout.png)
...
![WindowsProtected1.png](/assets/attachments/WindowsProtected1.png)

Then click the `Run anyway` button. You should only encounter this the first time you run the program.

![WindowsProtected2.png](/assets/attachments/WindowsProtected2.png)
## Setting It Up
...
![FileProperties.png](/assets/attachments/FileProperties.png)
...
![ModMan1.png](/assets/attachments/ModMan1.png)

## Advanced Settings

**Developer Mode**  

This enables the developer console in the game will allow you to type commands. A great article on what you can do with developer mode is [here](https://www.yekbot.com/farming-simulator-19-console-commands-developer-console/){: target="_blank" }.
...
![ModManShowAdvancedMenuOption.png](/assets/attachments/ModManShowAdvancedMenuOption.png)

![ModManSelectedModFolder.png](/assets/attachments/ModManSelectedModFolder.png)