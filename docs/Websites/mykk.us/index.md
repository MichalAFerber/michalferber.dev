...
- **Click Redirect**: Clicking the image redirects to [Krispy Kreme's official website](https://www.krispykreme.com/){: target="_blank" }.
...
- Open the website ([https://mykk.us](https://mykk.us/){: target="_blank" }) in a browser.
- The appropriate image will load based on your device’s viewport size.
- Click the image to be redirected to [https://www.krispykreme.com/](https://www.krispykreme.com/){: target="_blank" }.
...
- The website is live at [https://mykk.us](https://mykk.us/){: target="_blank" }.
