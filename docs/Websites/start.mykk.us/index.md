...
- [GitHub Pages setup](https://docs.github.com/en/get-started/quickstart/hello-world){: target="_blank" } ([GitHub](https://github.com/?utm_source=chatgpt.com "GitHub · Build and ship software on a single, collaborative platform ..."){: target="_blank" }, [YouTube](https://www.youtube.com/watch?pp=0gcJCfwAo7VqN5tD&v=277gRTVtw2I&utm_source=chatgpt.com "How to Get Started with GitHub (as a new developer){: target="_blank" } - YouTube"), [GitHub Docs](https://docs.github.com/get-started/quickstart/hello-world?utm_source=chatgpt.com "Hello World - GitHub Docs"){: target="_blank" })
- [Creating a pull request on GitHub](https://docs.github.com/en/get-started/quickstart/hello-world){: target="_blank" } ([GitHub Docs](https://docs.github.com/get-started/quickstart/hello-world?utm_source=chatgpt.com "Hello World - GitHub Docs"){: target="_blank" })
